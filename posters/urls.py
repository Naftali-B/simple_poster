...
urlpatterns = [
    ...
    path('generate_poster_two/<path:bg_image_url>/<path:overlay_img_url>/<str:text_color>/<str:text1>/<str:text2>/<str:text3>/<str:text4>/', views.generate_poster_two, name='generate_poster_two'),
